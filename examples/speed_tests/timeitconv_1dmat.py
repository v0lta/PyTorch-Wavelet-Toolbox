...
if __name__ == '__main__':
    ...
    print(f"1d-ptwt-jit:{np.mean(ptwt_time_gpu_mat):5.5f} +- {np.std(ptwt_time_gpu_mat):5.5f}")

    time_stack = np.stack([pywt_time_cpu, ptwt_time_cpu, ptwt_time_gpu, ptwt_time_gpu_mat], -1)
    ...
    tikzplotlib.save("./figs/timeitconv1dmat.tex", standalone=True, encoding="utf8")
